...
global pretrained_path = f"{log_path}/pretrained_nets"
...
def pretrained_stimuli(model_name, pretrained=True, projection=False):
    ...
    if pretrained:
        ...
        emb_path = join(pretrained_path, '/manifold/embeddings_new/macaque/{}/'.format(model_name))
    else:
        ...
        emb_path = join(pretrained_path, '/manifold/embeddings_new/macaque/{}_untrained/'.format(model_name))
    """
...
def snr_components(model_name, fname, root_path, projection=False):
