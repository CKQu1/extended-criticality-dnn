...
for f1 in os.listdir(main_path):
    f1_path = os.path.join(main_path, f1)
...
for i in range(len(metric_names)):
    ...
    if i == 2:
        ...
        axis.plot(x, y_stable, linewidth=1.8*1.8, linestyle='dashed', label = 'Stable')
        ...
        axis_inset.plot(x, y_normal, linewidth=1.5*1.8, linestyle='solid', label = 'Normal')
