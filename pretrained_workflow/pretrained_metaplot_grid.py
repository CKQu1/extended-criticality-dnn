...
for init_epoch in init_epochs:
    axs_2[0].axvline(x=init_epoch, c='grey', linestyle="--", linewidth=lwidth-2)
...
axs_2[1].set_xticks([2,4,6,8])
axs_2[1].set_xticklabels([2,4,6,8])
...
# legend
axs_2[0].legend(loc='lower left', ncol=1, fontsize=legend_size, frameon=False)
...
axs_2[1].legend(loc = 'upper left', fontsize = legend_size, frameon=False)
