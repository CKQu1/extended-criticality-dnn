...
if __name__ == '__main__':
    ...
    # self added
    parser.add_argument('--alpha100', default=200, type=int)
    parser.add_argument('--g100', default=100, type=int)  
    parser.add_argument('--hidden_structure', default=2, type=int)  
    ...
    if args.model == 'fc':
        depth = args.depth
        alpha100, g100 = int(args.alpha100), int(args.g100)
        hidden_structure = args.hidden_structure
